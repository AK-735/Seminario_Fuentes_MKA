...
Cabe destacar que aquellos hombres en el estudio que marcaron la opción de "Bisexual" formaron parte del grupo "HSH".
...
Podemos presenciar en la tabla la correlación que existe entre ser hombre y padecer esta enfermedad. Por otra parte, es cierto que los hombres en el estudio tendían a tener un número de parejas mayor que las mujeres, por lo que eso afecta a la certeza de estos datos.
...
Correlación si la caída o subida de casos está acompañado por un cambio en los factores de riesgo.
